...
# set terminal png nocrop font "/usr/share/fonts/dejavu/DejaVuSans.ttf,12" fontscale 1.0 size 300,600 
# set output 'plotting.ipm5.png'
unset clip points
set clip one
unset clip two
...
set title "2.5 micro Joules, 800 micron spot" 
...
GNUTERM = "x11"
plot 'xppc00117_r119_ipm5_del12.out.diff' mat u 1:($3+15*$2) lc -1 notitle
#    EOF
