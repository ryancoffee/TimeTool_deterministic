...
cubic(x)=a+b*(x-x0)+c*(x-x0)**3+d*(x-x0)**7
GNUTERM = "x11"
file = "amox28216_r74_diagnostics.dat"
filetim = "amox28216_r74_delays.dat"
a = 2.35974901678535
b = -0.7
x0 = -6
c = 0.000786734763210704
d = -5.34260217982419e-06
GPFUN_cubic = "cubic(x)=a+b*(x-x0)+c*(x-x0)**3+d*(x-x0)**7"
FIT_CONVERGED = 1
FIT_NDF = 2132
FIT_STDFIT = 0.191779152575967
FIT_WSSR = 78.4133468493957
plot file u 2:1,filetim u 2:($1+.0125),cubic(x)
## fit cubic(x) file u 2:(($1>-3 & $1<1.5 ? $1 : 0./0)) via a,c,d
#    EOF
