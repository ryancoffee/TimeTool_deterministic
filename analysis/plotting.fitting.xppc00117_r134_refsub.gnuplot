...
set term png color enhanced size 800,800
set output './analysis/plotting.fitting.xppc00117_r134_refsub.png'
plot f(x) lw 2 lc -1 title 'fit curve',\
	'./data_fs/processed/xppc00117_r134_refsub_ipm7.out.inds' u 1:($1-$2) notitle ,\
	'./data_fs/processed/xppc00117_r134_refsub_ipm8.out.inds' u 1:($1-$2) notitle ,\
	'./data_fs/processed/xppc00117_r134_refsub_ipm9.out.inds' u 1:($1-$2) notitle ,\
	'./data_fs/processed/xppc00117_r134_refsub_ipm10.out.inds' u 1:($1-$2) notitle
#    EOF
